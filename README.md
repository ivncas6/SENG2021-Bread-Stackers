...
```
cd existing_repo
git remote add origin https://gitlab.cse.unsw.edu.au/z5479134/SENG2021-bread-stackers.git
git branch -M main
...
* [Set up project integrations](https://gitlab.cse.unsw.edu.au/z5479134/SENG2021-bread-stackers/-/settings/integrations)
